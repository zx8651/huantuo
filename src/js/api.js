...
const Http = {
  get: (url, data) => {
    return formatReq('GET', url, data)
  },
  post: (url, data, isJSON) => {
    return formatReq('post', url, data, isJSON)
  },
  put: (url, data) => {
    return formatReq('put', url, data)
  },
  patch: (url, data) => {
    return formatReq('patch', url, data)
  },
  delete: (url, data) => {
    return formatReq('delete', url, data)
  }
}
export default Http
